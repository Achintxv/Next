...
import { Checkbox } from '../animate-ui/primitives/radix/checkbox';
...
// Helper: Standard function for logic outside the component
function getPathAnimate(isChecked) {
  return {
...
// Helper: Standard function for transitions
function getPathTransition(isChecked) {
  return {
...
export function PlayfulTodolist() {
  ...
  return (
    <div className="bg-neutral-100 text-white dark:bg-neutral-900 rounded-2xl p-6 space-y-6">
