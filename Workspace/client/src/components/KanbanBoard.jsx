...
//         {ideas.filter((i) => i.status === keyName).map((card) => (
//         //   <motion.div
//         //     key={card.id}
//         //     layout
//         //     className="bg-zinc-700 p-3 rounded-lg cursor-pointer hover:bg-zinc-600 transition text-sm"
//         //     onClick={() => {
//         //       if (keyName === "todo") moveCard(card, "todo", "doing");
//         //       else if (keyName === "doing") moveCard(card, "doing", "done");
//         //     }}
//         //   >
//         //     {card.text}
//         //   </motion.div>
...
//   key={card.id}
//   layout
//   className="group relative bg-zinc-700 p-3 rounded-lg cursor-pointer hover:bg-zinc-600 transition text-sm flex justify-between items-center"
// >
...
//   {/* DELETE BUTTON */}
//   <button
//     onClick={() => handleDelete(card.id, keyName)}
//     className="opacity-0 group-hover:opacity-100 text-red-400 hover:text-red-500 text-xs ml-2 transition"
//   >
//     ✕
//   </button>
...
//   return (
//     <div className="w-full h-full flex flex-col bg-zinc-800 rounded-xl border border-zinc-700 p-4 text-white">

//       {/* 🔹 Top Bar */}
//       <div className="flex justify-between items-center mb-4">
//         <h2 className="text-sm font-semibold text-zinc-400">Ideas Board</h2>
...
//         <Column title="Todo" keyName="todo" className="custom-scrollbar"/>
